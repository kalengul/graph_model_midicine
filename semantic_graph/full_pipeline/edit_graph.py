...
#     # Определяем соответствие тегов уровням
#     tag_to_level = {
#         'target_drug': 0,
#         'mechanism': 1
#     }
    
#     # Присваиваем уровень каждому узлу в зависимости от его тега
#     for node in G.nodes:
#         tag = G.nodes[node].get('tag', 'unknown')   # Получаем тег, если он существует, иначе 'unknown'
#         level = tag_to_level.get(tag, 2)            # По умолчанию присваиваем уровень 3, если тег не найден
