# Generated by Django 5.2 on 2025-04-14 08:14
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(max_length=255, unique=True, verbose_name='URL')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='Пользователь')),
                ('pg', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='medscape_api.druggroup', verbose_name='Группа лекарственных средств')),
            ],
            options={
                'verbose_name': 'ЛС',
        ...
        migrations.AddField(
            model_name='namedrugsmedscape',
            name='group_type',
            field=models.ManyToManyField(to='medscape_api.typedrugsmedscape'),
        ),
        migrations.CreateModel(
