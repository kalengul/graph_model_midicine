...
interface ForceGraphARGenericInstance<ChainableInstance>
...
type ForceGraphARInstance = ForceGraphARGenericInstance<ForceGraphARInstance>;

declare function ForceGraphAR(configOptions?: ConfigOptions): ForceGraphARInstance;

export { type ConfigOptions, type ForceGraphARGenericInstance, type ForceGraphARInstance, ForceGraphAR as default };
