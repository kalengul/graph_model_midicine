...
409 - Расчёт комбинаций уже запущен
...
`POST api/v1/reports/running/cancel/`
...
202 - Расчёт успешно отменился
404 - Активного расчёта нет
404 - Расчёт завершился между запросом и отменой
...
200 - Расчёт передан
404 - Расчёт отсутсвует (либо файла нет)
...
200 - Расчёт удалён
409 - Выбранный расчёт ещё запущен
