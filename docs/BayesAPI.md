...
## URL
```POST api/v1/polifarmakoterapiya-bayes/?drugs=[список лс для расчета]```
## Аутентификация
Не требуется
## Вход
...
|**параметр**|**Тип данных**|**Обязательность**|**Описание**|
|:----------:|:--------|:--------|:------|
|age         |String   |нет      |Принимает одно из вариантов сзначений "childe" "average" "pension"|
...
```json
{
    ...
    "data": [
        {"cont_id": 1, "cont_name": "противопоказание 1"},
        {"cont_id": 2, "cont_name": "противопоказание 2"}
    ]
}
```
