...
### Пример выходныйх данных для одной группы ЛС
```json
{
    "result": {
        "status": 200, 
...
### Пример выходныйх данных для успешного добавления группы ЛС
```json
{
    "result": {
        "status": 200, 
...
### Пример выходныйх данных при успешном добавлении ЛС
```json
{
    "result": {
        "status": 200, 
...
### Пример выходныйх данных при успешном запросе
```json
{
    "result": {
        "status": 200, 
