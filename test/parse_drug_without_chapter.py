...
def html_parse(name, url):
    ...
    if html_content:
        ...
        def get_text_by_id(soup, element_id):
            ...
            if element:
                ...
                while next_element:
                    text.append(clean_text(next_element.get_text()))
        ...
        data = {
            "Название": name,
            "фармакология": get_text_by_id(soup, "pharmakologiya"),
    ...
    with open(f"./json_drug_without_chapter/{active_substance}.json", 'w', encoding='utf-8') as json_file:
